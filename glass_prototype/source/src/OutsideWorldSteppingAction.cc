/*
 * OutsideWorldSteppingAction.cpp
 *
...
OutsideWorldSteppingAction::OutsideWorldSteppingAction(HistoManager* histoManager) : G4UserSteppingAction(), fHistoManager(histoManager) {
}

OutsideWorldSteppingAction::~OutsideWorldSteppingAction() {
}

void OutsideWorldSteppingAction::UserSteppingAction(const G4Step* step)
{
