...
// ********************************************************************
//
/// \file DetectorConstructionAna02.cc
/// \brief Implementation of the DetectorConstructionAna02 class
//
//
//
//
...
#include "DetectorMessengerAna02.hh"
...
DetectorConstructionAna02::DetectorConstructionAna02()
 ...
 fDetectorMessenger(0)
{
  ...
  fDetectorMessenger = new DetectorMessengerAna02(this);
}
...
G4VPhysicalVolume* DetectorConstructionAna02::Construct()
{
...
void DetectorConstructionAna02::DefineMaterials()
{
...
G4VPhysicalVolume* DetectorConstructionAna02::ConstructCalorimeter()
{
...
void DetectorConstructionAna02::PrintCalorParameters()
{
  G4cout << "\n------------------------------------------------------------"
...
void DetectorConstructionAna02::SetAbsorberMaterial(G4String materialChoice)
{
...
void DetectorConstructionAna02::SetGapMaterial(G4String materialChoice)
{
  // search the material by its name
  G4Material* pttoMaterial =
  G4NistManager::Instance()->FindOrBuildMaterial(materialChoice);
...
void DetectorConstructionAna02::SetAbsorberThickness(G4double val)
{
...
void DetectorConstructionAna02::SetGapThickness(G4double val)
{
...
void DetectorConstructionAna02::SetCalorSizeYZ(G4double val)
{
...
void DetectorConstructionAna02::SetNbOfLayers(G4int val)
{
  fNbOfLayers = val;
  if ( G4StateManager::GetStateManager()->GetCurrentState() != G4State_PreInit ) {
    G4RunManager::GetRunManager()->ReinitializeGeometry();
