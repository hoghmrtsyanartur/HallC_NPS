...
// ********************************************************************
//
/// \file DetectorMessengerAna02.cc
/// \brief Implementation of the DetectorMessengerAna02 class
//
//
//
//
...
DetectorMessengerAna02::DetectorMessengerAna02(DetectorConstructionAna02* Det)
: G4UImessenger(),
 fDetector(Det),
 fDetDir(0),
 fAbsMaterCmd(0),
...
DetectorMessengerAna02::~DetectorMessengerAna02()
{
  delete fNbLayersCmd;
...
void DetectorMessengerAna02::SetNewValue(G4UIcommand* command,G4String newValue)
{
