...
// ********************************************************************
//
/// \file DetectorConstructionAna02.hh
/// \brief Definition of the DetectorConstructionAna02 class
//
//
//
//
...
#ifndef DetectorConstructionAna02_h
#define DetectorConstructionAna02_h 1
...
class G4Material;
class DetectorMessengerAna02;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

class DetectorConstructionAna02 : public G4VUserDetectorConstruction
{
  public:

    DetectorConstructionAna02();
    virtual ~DetectorConstructionAna02();
  ...
  private:
     ...
     DetectorMessengerAna02* fDetectorMessenger;  //pointer to the Messenger
...
inline void DetectorConstructionAna02::ComputeCalorParameters()
{
